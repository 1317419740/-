...
button = tkinter.Button(top)
button['text'] = '2.δ[n]'
button['command'] = math1
button.pack(side='left')

button = tkinter.Button(top)
button['text'] = '3.u[n]'
button['command'] = math2
button.pack(side='left')

button = tkinter.Button(top)
button['text'] = '4.G_N[n]'
button['command'] = math3
button.pack(side='left')

button = tkinter.Button(top)
button['text'] = '5.δN[n]'
button['command'] = math4
button.pack(side='left')

button = tkinter.Button(top)
button['text'] = '6.δN[n]'
button['command'] = math5
button.pack(side='left')

button = tkinter.Button(top)
button['text'] = '7.x[n]=ca^n'
button['command'] = math6
button.pack(side='left')

button = tkinter.Button(top)
button['text'] = '8.cos(8n/31)'
button['command'] = math7
button.pack(side='left')

button = tkinter.Button(top)
button['text'] = '9.x[n]'
button['command'] = math8
button.pack(side='left')
top.mainloop()
